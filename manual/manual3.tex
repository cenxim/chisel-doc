...
This document is a manual for {\em Chisel Version 3} (Constructing Hardware In a
...
Section~\ref{sec:ports}.  Finally, users can override the \code{cloneType}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.45\textwidth]{../tutfigs/DUT.pdf}
\end{center}
